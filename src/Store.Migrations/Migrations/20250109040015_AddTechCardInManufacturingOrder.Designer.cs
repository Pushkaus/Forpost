...
namespace Forpost.Store.Migrations.Migrations
{
    ...
    [Migration("20250109040015_AddTechCardInManufacturingOrder")]
    partial class AddTechCardInManufacturingOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Forpost.Domain.CRM.InvoiceManagement.Invoice", b =>
                {
                    ...
                    b.Property<bool>("IsManufacturingOrderSent")
            ...
            modelBuilder.Entity("Forpost.Domain.Catalogs.Contractors.Contractor", b =>
                {
                    ...
                    b.Property<string>("LogisticInfo")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("Forpost.Domain.Catalogs.Contractors.ContractorRepresentatives.ContractorRepresentative", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ContractorRepresentatives");
                });
            ...
            modelBuilder.Entity("Forpost.Domain.Catalogs.TechCards.TechCardOperations.TechCardOperation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forpost.Domain.ProductCreating.ManufacturingOrders.ManufacturingOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("ManufacturingOrderStatus")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Forpost.Domain.ProductCreating.ManufacturingOrders.ManufacturingOrderComposition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("ManufacturingProcessOrderId")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ManufacturingOrderCompositions");
                });
            ...
            modelBuilder.Entity("Forpost.Domain.StorageManagement.EntryStorageHistories.EntryStorageHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Forpost.Store.Postgres.ChangeHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
