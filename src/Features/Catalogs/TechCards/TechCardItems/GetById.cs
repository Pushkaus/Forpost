...
internal sealed class
    GetTechCardItemByIdQueryHandler : IQueryHandler<GetTechCardItemByIdQuery, IReadOnlyCollection<TechCardItem>>
{
    ...
    public async ValueTask<IReadOnlyCollection<TechCardItem>> Handle(GetTechCardItemByIdQuery request,
