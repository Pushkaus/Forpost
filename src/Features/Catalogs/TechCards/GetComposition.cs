...
internal sealed class
    GetCompositionTechCardQueryHandler : IQueryHandler<GetCompositionTechCardQuery, CompositionTechCardModel?>
{
    ...
    public async ValueTask<CompositionTechCardModel?> Handle(GetCompositionTechCardQuery query,
